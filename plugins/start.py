...
@Bot.on_message(filters.private & filters.command('pbroadcast') & filters.user(OWNER_ID))
...
@Bot.on_message(filters.private & filters.command('dbroadcast') & filters.user(OWNER_ID))
